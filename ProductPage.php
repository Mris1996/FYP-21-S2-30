...
#valuecontainer input[type=submit]{
...
#valuecontainer input[type=submit]:hover {
	 outline:60%;
    filter: drop-shadow(0 0 5px purple);
...
<center><h1 style="font-size:70px" ><?php echo  $ProductObj->ProductName; ?></h1></center>
...
<center>
<h1 style="margin-top:5%;">Product By</h1>
